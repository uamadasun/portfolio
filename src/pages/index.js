    ...
    <Layout>
      ...
      <div className="w-5/6 mx-auto md:h-screen mb-60 align-center place-items-center mainGrid"  id="home">
        ...
        <section className="aboutMe" id="about">
            <img src={uchebw} alt="Uche at kerry Park, seattle" className="uche-bw"/>
            <img className="hoverImage" src={uchecolor} alt="Uche at kerry Park, seattle"/>
            <div className="aboutBox">
              <p>
                Hi! My name is Uchenna and I am a freelance web developer. 
